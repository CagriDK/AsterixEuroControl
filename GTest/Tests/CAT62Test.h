...
{
    const char *fullSampleData62 = "";
    ...
    EXPECT_EQ(jData.at("encodedHexData"), fullSampleData62);
    ...
    EXPECT_EQ(jData.at("070").at("Time Of Track Information"), 28443.5);
    ...
    EXPECT_EQ(jData.at("100").at("X"), 121740.0);
    EXPECT_EQ(jData.at("100").at("Y"), 118528.0);
    ...
    EXPECT_EQ(jData.at("110").at("TOS").at("TOS"), 100); // 0
    ...
    EXPECT_EQ(jData.at("130").at("Altitude"), 100);
    EXPECT_EQ(jData.at("135").at("QNH"), 0);
    EXPECT_EQ(jData.at("135").at("Calculated Track Barometric Altitude"), 100);
    EXPECT_EQ(jData.at("136").at("Measured Flight Level"), 16.0);
    EXPECT_EQ(jData.at("185").at("Vx"), 33.75);
    EXPECT_EQ(jData.at("185").at("Vy"), -0.5);
    ...
    EXPECT_EQ(jData.at("210").at("Ax"), 100); // -28
    EXPECT_EQ(jData.at("210").at("Ay"), 100); // -28
    EXPECT_EQ(jData.at("220").at("Rate of Climb/Descent"), 593.75);
    EXPECT_EQ(jData.at("245").at("STI"), 2);
    EXPECT_EQ(jData.at("245").at("Target Identification"), "AIRCID56");
    EXPECT_EQ(jData.at("270").at("LENGTH"), 100);
    EXPECT_EQ(jData.at("270").at("FX"), 1);
    EXPECT_EQ(jData.at("270").at("ORIENTATION"), 100); // 98.4375
    EXPECT_EQ(jData.at("270").at("FX2"), 1);
    EXPECT_EQ(jData.at("270").at("WIDTH"), 100);
    EXPECT_EQ(jData.at("270").at("FX3"), 0);

    EXPECT_EQ(jData.at("290").at("TRK").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("PSR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("SSR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("MDS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("ADS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("ES").at("Age"), 100);  // 36
    EXPECT_EQ(jData.at("290").at("VDL").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("UAT").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("LOP").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("290").at("MLT").at("Age"), 100); // 36
    ...
    EXPECT_EQ(jData.at("295").at("MFL").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MD1").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MD2").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MDA").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MD4").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MD5").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MHG").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("IAS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("TAS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("SAL").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("FSS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("TID").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("COM").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("SAB").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("ACS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("BVR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("GVR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("RAN").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("TAR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("TAN").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("GSP").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("VUN").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MET").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("EMC").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("POS").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("GAL").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("PUN").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MB").at("Age"), 100);  // 36
    EXPECT_EQ(jData.at("295").at("IAR").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("MAC").at("Age"), 100); // 36
    EXPECT_EQ(jData.at("295").at("BPS").at("Age"), 100); // 36
    ...
    EXPECT_EQ(jData.at("340").at("POS").at("RHO"), 100);
    EXPECT_EQ(jData.at("340").at("POS").at("THETA"), 100); // 99.99755859375
    EXPECT_EQ(jData.at("340").at("HEI").at("HEIGHT"), 100);
    EXPECT_EQ(jData.at("340").at("MDC").at("V"), 1);
    EXPECT_EQ(jData.at("340").at("MDC").at("G"), 0);
    EXPECT_EQ(jData.at("340").at("MDC").at("Last Measured Mode C Code"), 1270);
    ...
    EXPECT_EQ(jData.at("390").at("CFL").at("CFL"), 100);
    ...
    EXPECT_EQ(jData.at("390").at("PEM").at("Mode-3/A reply"), 120000); // 0
    ...
    EXPECT_EQ(jData.at("500").at("APC").at("APC (X-Component)"), 100.0);
    EXPECT_EQ(jData.at("500").at("APC").at("APC (Y-Component)"), 100.0);
    EXPECT_EQ(jData.at("500").at("COV").at("COV (XY Covariance Component)"), 100.0);
    EXPECT_EQ(jData.at("500").at("APW").at("APW (Latitude Component)"), 100.0);  // 0.15625476837158203
    EXPECT_EQ(jData.at("500").at("APW").at("APW (Longitude Component)"), 100.0); // 0.15625476837158203
    EXPECT_EQ(jData.at("500").at("AGA").at("AGA"), 100.0);
    EXPECT_EQ(jData.at("500").at("ABA").at("ABA"), 100.0);               // 36
    EXPECT_EQ(jData.at("500").at("ATV").at("ATV (X-Component)"), 100.0); // 36
    EXPECT_EQ(jData.at("500").at("ATV").at("ATV (Y-Component)"), 100.0); // 36
    EXPECT_EQ(jData.at("500").at("AA").at("AA (X-Component)"), 100.0);   // 36
    EXPECT_EQ(jData.at("500").at("AA").at("AA (Y-Component)"), 100.0);   // 36
    EXPECT_EQ(jData.at("500").at("ARC").at("ARC"), 100.0);
